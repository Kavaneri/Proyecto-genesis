                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className=" container">
                            ...
                            <Row className="mb-3">
                                ...
                                <Form.Group as={Col} className='mb-4' controlId='formGridPassword'>
                                    <Form.Label style={{ color: 'white' }}>Nuip</Form.Label>
                        ...
                        <div className="container">
                            ...
                            <Row className="mb-3">
                                ...
                                <Form.Group as={Col} controlId="formGridState">
                                    <Form.Label style={{ color: 'white' }}>Especie</Form.Label>
                        ...
                        <div className="container">
                            ...
                            <Row className="mb-3">
                                ...
                                <Form.Group as={Col} controlId="formGridState">
                                    <Form.Label style={{ color: 'white' }}>Servicio</Form.Label>
                                    <Form.Select defaultValue="Choose...">
                                        <option value="NULL" >...</option>
                            ...
                            <Row>
                                <Form.Group as={Col} controlId="formGridState">
                                    <Form.Label style={{ color: 'white' }}>Tipo de domicilio</Form.Label>
                                    <Form.Select defaultValue="Choose...">
                            ...
                            <Row className="mb-3">
                                ...
                                <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                                    <Form.Label style={{ color: 'white' }}>Observaciones (Opcional)</Form.Label>
